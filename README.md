...
Go to the [Examples folder](examples) to learn how to modify individual
examples.
...
- From `dist` folder, copy the folders `css`, `fonts`, and the file
...
LiteMol is available with 3 colors schemes: Dark (default), Light, and Blue. The
